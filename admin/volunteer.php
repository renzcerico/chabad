...
<body>
  ...
  <div class="wrapper">
    ...
    <div id="content" class="content1 container-fluid">
      <div class=" align-items-center pt-3 pb-2 mb-3 border-bottom flex-md-nowrapap flex-md-nowrap">
        <h1 class="h4 pt-3 pb-3 text-center">Volunteer</h1>
        ...
        <div class="col-lg-8 col-md-8 col-sm-12 col-12">
           <div class="card card_api">
                <div class="card-body p-5">
                    <table id="tblVolunteer" class="table table-bordered text-center table-sm bg-white table-hover">
                        <thead>
                            <tr>
                                <th>Name</th>
                                <th>Date</th>
  ...
  <script>
    ...
    $(() => {
        ...
        const volunteerClick = (e) => {
          const id = e.currentTarget.getAttribute('data-id');
          window.location.href = 'volunteers.php?id=' +id;
        };

        $(document).on('click', '#tblVolunteer>tbody tr', (e) => volunteerClick(e));
    });
  </script>
