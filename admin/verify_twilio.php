                ...
                <div class="card-body p-5">
                    <form id="api_form">
                        <div class="form-group">
                             <label for="verification">Enter 6 Digit Verification Code:</label>
                             <input type="text" id="verification" class="form-control" placeholder="Enter Verification Code"/>
                        </div>
        ...
        if(verification==''){
              ...
              $.ajax({
                ...
                success: (res) => {
                    ...
                    // window.location.replace('twilio.php');
                }
          });
        }
